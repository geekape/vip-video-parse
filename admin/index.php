		...
		<div id="hd_main">
		   ...
		   <div style="margin-top:20px ;">
		   	<?php $path = $_SERVER['SCRIPT_NAME'];
			    ...
			    if(strpos($path,'/admin/')>-1){
				   echo '<div class="tishi-houtai"><p><span>!</span>猿梦提醒您：您的后台目录默认为 域名/admin ，为了安全请尽快修改后台目录</p></div>';	
				}
		   ...
		   ?>
		    ...
		    <table width="600" border="0" class="tablecss" cellspacing="0" cellpadding="0" align="center">
				<tr>
				   <td colspan="2" align="center">欢迎使用猿梦解析管理系统！</td>
				</tr>
			  	<tr>
				    <td align="right">当前使用版：</td>
				    <td><span>猿梦解析系统V1版本</span></td>
			  	</tr>
			  	<tr>
